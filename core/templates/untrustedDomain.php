	...
	<li class='error'>
		...
		<p class='hint'>
			...
			<p style="text-align:center;">
				<a href="<?php print_unescaped(\OC::$server->getURLGenerator()->getAbsoluteURL(\OCP\Util::linkToRoute('SettingsPage#getAdmin'))); ?>?trustDomain=<?php p($_['domain']); ?>" class="button">
